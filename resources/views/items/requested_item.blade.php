        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div id="filters" class="d-flex flex-wrap align-items-end gap-2">
                            ...
                            <div class="col-md-1">
                                <label for="filter_country">{{__("State")}}</label>
                                <select class="form-control bootstrap-table-filter-control-state" id="filter_state_item_test">
                                    <option value="">{{__("All")}}</option>
                            ...
                            <div class="col-md-1">
                                <label for="filter_all_c1">{{__("Category")}}</label>
                                <select class="form-control bootstrap-table-filter-control-c1" id="filter_c1_item_test">
                                    <option value="">{{__("All")}}</option>
                            ...
                            <div class="col-md-2">
                                <label for="filter_all_c2">{{__("SubCategory")}}</label>
                                <select class="form-control bootstrap-table-filter-control-c2" id="filter_c2_item_test">
                                    <option value="">{{__("All")}}</option>

                                </select>
                            </div>
                            <div class="col-md-2">
                                <label for="filter_category_id">{{__("SubSubCategory")}}</label>
                                <select class="form-control bootstrap-table-filter-control-category_id"
                                        id="filter_category_id_item_test">
                                    <option value="">{{__("All")}}</option>
                ...
                <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                       data-toggle="table" data-url="{{ route('advertisement.show','requested') }}"
                    ...
                    <tr>
                        ...
                        <th scope="col" data-field="gallery_images" data-sortable="false"
                            data-formatter="galleryImageFormatter" data-escape="false">{{ __('Other Images') }}</th>
                        ...
                        <th scope="col" data-field="c1" data-sortable="true" data-filter-data=""
                            data-visible="true">{{ __('Category') }}</th>
                        <th scope="col" data-field="c2" data-sortable="true" data-filter-data=""
                            data-visible="true">{{ __('SubCategory') }}</th>
                        <th scope="col" data-field="category_id" data-sortable="true" data-filter-data=""
                            data-visible="true">{{ __('SubSubCategory') }}</th>
                        <th scope="col" data-field="country" data-sortable="true" data-filter-control="select"
                            data-filter-data="" data-visible="true">{{ __('Country') }}</th>


                        <th scope="col" data-field="state" data-sortable="true"
                            data-visible="true">{{ __('State') }}</th>
                        <th scope="col" data-field="city" data-sortable="true" data-filter-control="select"
                            data-filter-data="" data-visible="true">{{ __('City') }}</th>
                        <th scope="col" data-field="featured_status" data-sortable="false" data-filter-control="select"
                            data-filter-data=""
                            data-formatter="featuredItemStatusFormatter">{{ __('Featured/Premium') }}</th>
                        <th scope="col" data-field="status" data-sortable="true" data-filter-control="select"
                            data-filter-data="" data-escape="false"
                            data-formatter="itemStatusFormatter">{{ __('Status') }}</th>

{{--                        <th scope="col" data-field="views" data-sortable="true" data-visible="true" data-switchable="true">{{ __('Views') }}</th>--}}
{{--                        <th scope="col" data-field="share" data-sortable="true" data-visible="true" data-switchable="true">{{ __('Share') }}</th>--}}
{{--                        <th scope="col" data-field="favourite" data-sortable="true" data-visible="true" data-switchable="true">{{ __('Favourite') }}</th>--}}
{{--                        <th scope="col" data-field="chat" data-sortable="true" data-visible="true" data-switchable="true">{{ __('Chat') }}</th>--}}
{{--                        <th scope="col" data-field="count_call" data-sortable="true" data-visible="true" data-switchable="true">{{ __('Call') }}</th>--}}
                        @can('item-update')
                            <th scope="col" data-field="active_status" data-sortable="true" data-sort-name="deleted_at"
                                data-visible="true" data-escape="false"
                                data-formatter="statusSwitchFormatter">{{ __('Active') }}</th>
                        @endcan
                        <th scope="col" data-field="rejected_reason" data-sortable="true" data-visible="true"
                            data-formatter="rejectedReasonFormatter">{{ __('Rejected Reason') }}</th>
                        <th scope="col" data-field="expiry_date" data-sortable="true"
                            data-visible="true">{{ __('Expiry Date') }}</th>
                        <th scope="col" data-field="created_at" data-sortable="true" data-visible="true"
                            data-switchable="true">{{ __('Post on') }}</th>
                        <th scope="col" data-field="updated_at" data-sortable="true" data-visible="false"
                            data-switchable="false">{{ __('Updated At') }}</th>
                        <th scope="col" data-field="user_id" data-sortable="true" data-visible="false"
                            data-switchable="false">{{ __('User ID') }}</th>
                        <th scope="col" data-field="category_id" data-sortable="true" data-visible="false"
                            data-switchable="false">{{ __('Category ID') }}</th>
                        <th scope="col" data-field="likes" data-sortable="true" data-visible="false"
                            data-switchable="false">{{ __('Likes') }}</th>
{{--                        <th scope="col" data-field="clicks" data-sortable="true" data-visible="true"--}}
{{--                            data-switchable="true">{{ __('Views') }}</th>--}}
        ...
        <div id="editStatusModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel1">{{ __('Edit') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="edit-form" action="" method="POST" data-success-function="updateApprovalSuccess">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="filter_all_c1">{{__("Status")}}</label>
                                ...
                                <div class="col-md-12">
                                    <label for="filter_all_c1">{{__("Category")}}</label>
                                    <select class="form-control bootstrap-table-filter-control-c1" data-field="c1"
                                            id="filter_c1_item_test_status" name="c1" required>
                                        <option value="">{{__("All")}}</option>
                                        @foreach($categories as $category)
                                            <option value="{{$category->id}}">{{$category->name}}</option>
                                        @endforeach
                                ...
                                <div class="col-md-12">
                                    <label for="filter_all_c2">{{__("SubCategory")}}</label>
                                    <select class="form-control bootstrap-table-filter-control-c2"
                                            id="filter_c2_item_test_status" name="c2" >
                                        <option value="">{{__("All")}}</option>
                                ...
                                <div class="col-md-12">
                                    <label for="filter_category_id">{{__("SubSubCategory")}}</label>
                                    <select class="form-control bootstrap-table-filter-control-category_id"
                                            id="filter_category_id_item_test_status" name="category_id">
                                        <option value="">{{__("All")}}</option>
                            ...
                            <div id="rejected_reason_container" class="col-md-12" style="display: none;">
                                ...
                                <textarea name="rejected_reason" id="rejected_reason" class="form-control"
...
@section('script')
    ...
    <script>
        ...
        function AllData(cat1,id) {

            $('#filter_c1_item_test_status').val(cat1);

            // Send the selected value to the server using AJAX
            $.ajax({
                url: '/getsubcategoryname',
                method: 'POST',
                data: {
                    id: id,
                    _token: '{{ csrf_token() }}'
                ...
                success: function (response) {
                    $('#filter_c2_item_test_status').empty();
                    $('#filter_category_id_item_test_status').empty();
                    console.log('Server Response:', response);
                    $('#status').val(response['status']);

                    $('#filter_c2_item_test_status').append($('<option>', {
                        value: response['subid'],
                        text: response['subname']
                    }));

                    $('#filter_category_id_item_test_status').append($('<option>', {
                        value: response['subsubid'],
                        text: response['subsubname']
                    }));
                },
