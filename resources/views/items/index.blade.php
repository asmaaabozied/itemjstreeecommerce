                    ...
                    <div class="col-12">
                        <div id="filters" class="d-flex flex-wrap align-items-end gap-2 mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control bootstrap-table-filter-control-category_id" id="filter_category_id_item_test">
                                    <option value="">{{__("All")}}</option>
...
{{--                                <th scope="col" data-field="category_id" data-sortable="true"  data-filter-data="" data-visible="true">{{ __('Category') }}</th>--}}
                                <th scope="col" data-field="c1" data-sortable="true"  data-filter-data="" data-visible="true">{{ __('Category') }}</th>
                                <th scope="col" data-field="c2" data-sortable="true"  data-filter-data="" data-visible="true">{{ __('SubCategory') }}</th>
                                <th scope="col" data-field="category_id" data-sortable="true"  data-filter-data="" data-visible="true">{{ __('SubSubCategory') }}</th>
                                ...
                                <th scope="col" data-field="created_at" data-sortable="true" data-visible="true" data-switchable="true">{{ __('Post On') }}</th>
                                ...
                                <th scope="col" data-field="likes" data-sortable="true" data-visible="false" data-switchable="true">{{ __('Likes') }}</th>
                                ...
                                <th scope="col" data-field="count_call" data-sortable="true" data-visible="true" data-switchable="true">{{ __('Call') }}</th>                                @canany(['item-update','item-delete'])
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="edit-form" action="" method="POST" data-success-function="updateApprovalSuccess">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="filter_all_c2">{{__("Status")}}</label>
