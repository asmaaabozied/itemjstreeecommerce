                    ...
                    <div class="col-12">
                        <table class="table-borderless table-striped" aria-describedby="mydesc" id="table_list"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="is_company" data-sortable="true">{{ __('Is Company') }}</th>
                                <th scope="col" data-field="views" data-sortable="true">{{ __('Views') }}</th>

                                <th scope="col" data-field="clickemail" data-sortable="true">{{ __('ClickEmail') }}</th>
                                <th scope="col" data-field="clickchat" data-sortable="true">{{ __('Chat') }}</th>
                                <th scope="col" data-field="nif" data-sortable="true">{{ __('NIF') }}</th>
...
{{--        <div id="assignPackageModalAddress" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"--}}
{{--             aria-hidden="true">--}}
{{--            <div class="modal-dialog">--}}
{{--                <div class="modal-content">--}}
{{--                    <div class="modal-header">--}}
{{--                        <h5 class="modal-title" id="myModalLabel1">{{ __('Assign Address') }}</h5>--}}
{{--                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="resetModal()"></button>--}}
{{--                    </div>--}}
{{--                    <div class="modal-body">--}}
{{--                        <form class="create-form" action="{{ route('customer.assign.package') }}" method="POST" data-parsley-validate data-success-function="assignApprovalSuccess">--}}
