                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-borderless table-striped" aria-describedby="mydesc"
                               ...
                               data-sort-order="asc" data-pagination-successively-size="4" data-query-params="queryParams"
                               data-escape="true"
                            ...
                            <tr>
                                ...
                                @endcan
                                <th scope="col" data-field="views" data-align="center"  data-sortable="true"  >{{ __('Views') }}</th>
